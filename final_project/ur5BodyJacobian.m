function y = ur5BodyJacobian(q)
    ...
    y = [eye(6,1) eye(6,1) eye(6,1) eye(6,1) eye(6,1) eye(6,1)];
    for i = 1:6
        y(1:6,i) = pinv(adj(myexp(xi, i, 6, q)*gst0))*xi{i};
    end
...
function y = adj(g)
    R = g(1:3, 1:3);
    p = g(1:3, 4);
    y = [R, skew3(p)*R; [0, 0, 0; 0 0 0; 0 0 0], R];
end
